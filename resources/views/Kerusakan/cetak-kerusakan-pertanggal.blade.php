        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="/cetak-data-kerusakan-pertanggal" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
            ...
            <div class="panel panel-default">
              <div class="card card-info card-outline">
                ...
                <div class="card-body">
                  ...
                  <div class="input-group mb-3">
                    <a href="#" onclick="this.href='/Kerusakan/cetakpertanggal/'+document.getElementById('tglawal').value +
                      '/' + document.getElementById('tglakhir').value" class="btn btn-primary">
                      Cetak Laporan Pertanggal &nbsp;&nbsp;<i class="fas fa-print"></i></a>&nbsp;
                    <a href="/cetak-kerusakan" class="btn btn-primary">Cetak Keseluruhan</a>
                  </div>
                </div>
              </div>
              <div class="card card-info card-outline">
