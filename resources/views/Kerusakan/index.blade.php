        ...
        <div class ="col-md-12"> 
            <div class ="panel panel-default"> 
                <div class ="panel-head container-fluid" style="margin-top: 10px;"> 
                  <a href="/kerusakan/create" class="btn btn-primary"><i class=" fa fa-plus"></i>&nbsp; Tambah</a> 
                  <!-- <a href="/cetak-kerusakan" class="btn btn-primary"><i class=" fa fa-print"></i>&nbsp; Cetak Data</a>
                  <a href="/cetak-data-kerusakan-pertanggal" class="btn btn-primary"><i class=" fa fa-print"></i>&nbsp; Cetak Data Kerusakan</a> -->
                          ...
                          <table class="table table-striped" id="table-data"> 
                            ...
                            <tbody> 
                              ...
                              <tr> 
                                ...
                                <!-- <td>{{ $p->keterangan }}</td>  -->
                                <!-- <td>
                                  <img src="{{ asset('Gambar/'. $p->upload_foto ) }}" height="10%" width="32%" alt=""></img>
                                ...
                                <td> 
                                  ...
                                  <a href="/kerusakan/edit/{{$p->id_kerusakan}}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                  <a href="/kerusakan/destroy/{{$p->id_kerusakan}}" class="btn btn-danger" onclick="return confirm('Apakah Anda Ingin Menghapus?')"><i class="fa fa-trash"></i></a>
                                </td>
                              </tr> 
                              @endforeach
                            </tbody> 
