...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
              <h1 class="m-0">Data Detail Penyelesaian</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-12">
              <div class="panel panel-default">
                ...
                <div class="card-body">
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">ID Penyelesaian</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $penyelesaian->id_penyelesaian }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">ID Kerusakan</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $penyelesaian->id_kerusakan }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Nama Barang</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $penyelesaian->nama_barang }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Nama Teknisi</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $penyelesaian->nama_teknisi }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">No Telepon</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $penyelesaian->no_telepon }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Tanggal</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ date('d F Y', strtotime($penyelesaian->tanggal)) }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Lama Pengerjaan</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $penyelesaian->lama_pengerjaan }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Solusi</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $penyelesaian->solusi }}
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <a href="/penyelesaian" class="btn btn-warning">Kembali</a>
                    </div>
                  </div>
                </div>
              </div>
