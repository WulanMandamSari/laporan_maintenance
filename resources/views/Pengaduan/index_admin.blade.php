                      ...
                      <div class="pull-right"> <br/>
                        <div class="panel-body"> 
                          <table class="table table-striped" id="table-data"> 
                            ...
                            <tbody> 
                              @foreach ($pengaduan_admin as $i => $p)
                              <tr> 
                              <td>{{ $i+1 }}</td> 
                                ...
                                <td> 
                                  <a href="/pengaduan/show/{{$p->id_pengaduan}}" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                  <a href="/pengaduan/edit/{{$p->id_pengaduan}}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                  <a href="/pengaduan_admin/{{$p->id_pengaduan}}" class="btn btn-danger" onclick="return confirm('Apakah Anda Ingin Menghapus?')"><i class="fa fa-trash"></i></a>
                                </td>
                              </tr> 
                              @endforeach
                            </tbody> 
