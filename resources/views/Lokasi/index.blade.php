          ...
          <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-head container-fluid" style="margin-top: 10px;">
                <a href="/lokasi/create" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Tambah</a>
              ...
              <div class="panel-body">
                <table class="table table-striped" id="table-data">
                  ...
                  <tbody>
                    @foreach ($lokasi as $i => $p)
                    <tr>
                      <td>{{ $i+1 }}</td>
                      <!-- <td>{{ $p->id_lokasi }}</td> -->
                      <td>{{ $p->nama_lokasi }}</td>
                      <td>
                        <a href="/lokasi/edit/{{ $p->id_lokasi }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                        <a href="/lokasi/destroy/{{ $p->id_lokasi }}" class="btn btn-danger" onclick="return confirm('Apakah Anda Ingin Menghapus?')"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
