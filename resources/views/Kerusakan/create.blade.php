        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <div class="card-body">
                <form action="/kerusakan/store" method="post" enctype="multipart/form-data"> {{ csrf_field() }}
                <!-- <div class="form-group">
                    <label class="control-label col-md-8">ID Kerusakan</label>
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="id_kerusakan" value="{{old('id_kerusakan')}}">
                  ...
                  <!-- <div class="form-group">
                    <label class="control-label col-md-8">ID Pelapor</label>
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="id_pelapor" value="{{old('id_pelapor')}}">
                      @if($errors->has('id_pelapor'))
                          <div class="text-danger">
                            {{ $errors->first('id_pelapor')}}
                          </div>
                      @endif
                    </div> -->
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="keluhan" value="{{old('jenis_kerusakan')}}">
                  ...
                  <!-- <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="keluhan" value="{{old('keterangan')}}">
