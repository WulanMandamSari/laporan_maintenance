        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <div class="card-body">
                <form method="post" action="/barang/store" enctype="multipart/form-data"> {{ csrf_field() }}
                  <!-- <div class="form-group">
            <label class="control-label col-md-8">ID</label> 
            <div class="col-md-20"> 
                <input type="text" class="form-control" name="id_barang" disabled> 
</div> 
</div>  -->
                    <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">Stock</label>
                    <div class="col-md-20">
