        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <div class="card-body">
                <form class="form-horizontal" enctype="multipart/form-data" action="/kerusakan/update/{{ $kerusakan->id_kerusakan }}" method="post"> {{ csrf_field() }}
                  <input type="hidden" name="_method" value="PUT">
                  <!-- <div class="form-group">
                    <label class="control-label col-sm-2">ID</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="id" value="{{ $kerusakan->id }}" disabled>
                    </div>
                  </div>  -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="id_kerusakan" value="{{ $kerusakan->id_kerusakan }}" readonly>
                  ...
                  <!-- <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="nama_pelapor" value="{{ $kerusakan->nama_pelapor }}">
                  ...
                  <!-- <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="no_telepon" value="{{ $kerusakan->no_telepon }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <select class="form-control" name="id_barang" id="id_barang">
                        ...
                        <option value="{{ $item->id_barang ? $item->id_barang : ""}}" @if($kerusakan->id_barang === $item->id_barang) selected @endif >{{ $item->nama_barang}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="date" class="form-control" name="tanggal" value="{{ $kerusakan->tanggal }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="time" class="form-control" name="waktu" value="{{ $kerusakan->waktu }}">
                      @if($errors->has('waktu'))
                          <div class="text-danger">
                            {{ $errors->first('waktu')}}
                          </div>
                    ...
                    <div class="col-md-20">
                      <select class="form-control" name="id_lokasi" id="id_lokasi">
                        <!-- @foreach($lokasi as $item) 
                          @if($item->lokasi_id==$kerusakan->lokasi_id)
                        <option value={{ $item->lokasi_id }} selected>{{ $item->nama_lokasi}}</option> 
                          @else
                        ...
                        <option>Silahkan Pilih</option>
                        @foreach($lokasi as $item)
                        <option value="{{ $item->id_lokasi ? $item->id_lokasi : ""}}" @if($kerusakan->id_lokasi == $item->id_lokasi) selected @endif >{{ $item->nama_lokasi}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="jenis_kerusakan" value="{{ $kerusakan->jenis_kerusakan }}">
                  ...
                  <!-- <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="keterangan" value="{{ $kerusakan->keterangan }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      <tr>
                        <td><input type="file" class="form-control" name="file" id="inputGroupFile" value="{{ $kerusakan->upload_foto }}"></td>
                    ...
                    <div class="form-group"> 
                        <img src="{{ asset('Gambar/'. $kerusakan->upload_foto) }}" height="100%" width="30%" alt="">
                    </div> 
                  </div> -->
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-primary">Ubah Data</button>
                      <a href="/kerusakan" class="btn btn-danger">Kembali</a>
                    </div>
                  </div>
                </form>
              </div>
