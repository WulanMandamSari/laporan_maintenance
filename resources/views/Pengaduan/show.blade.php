    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
             <div class="col-sm-12">
              <h1 class="m-0">Data Detail Pengaduan</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
              <div class="form-horizontal">
                <div class="card-body"> 
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">ID Pengaduan</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $pengaduan->id_pengaduan }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Nama Pelapor</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $pengaduan->nama_pelapor }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">No Telepon</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $pengaduan->no_telepon }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Barang</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $pengaduan->barang->nama_barang }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Tanggal</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ date('d F Y', strtotime($pengaduan->tanggal)) }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                    <b>:</b> {{ $pengaduan->lokasi->nama_lokasi }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Kode Barang</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $pengaduan->kd_barang }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Jenis Kerusakan</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $pengaduan->jenis_kerusakan }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">Keterangan</label>
                    <div class="col-sm-10">
                    <b>:</b> {{ $pengaduan->keterangan }}
                    </div>
                  </div>
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                    <b>:</b>
                      <img src="{{ asset('Gambar/'. $pengaduan->upload_foto ) }}" height="113%" width="12%" alt="">
                      <!-- <a href="{{ asset('Gambar/'. $pengaduan->upload_foto ) }}" target="_blank" rel="noopener noreferrer">Lihat Gambar</a> -->
                      {{ $pengaduan->upload_foto }}
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <a href="/pengaduan_admin" class="btn btn-warning">Kembali</a>
                    </div>
                  </div>
                </div>
              </div>
