...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
              <h1 class="m-0">Data Penyelesaian</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-head container-fluid" style="margin-top: 10px;">
                <a href="/penyelesaian/create" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Tambah</a>
                <!-- <a href="/cetak-penyelesaian" class="btn btn-primary"><i class="fa fa-print"></i>&nbsp; Cetak Data</a>
                <a href="/cetak-data-penyelesaian-pertanggal" class="btn btn-primary"><i class=" fa fa-print"></i>&nbsp; Cetak Data Penyelesaian</a> -->
              ...
              <div class="panel-body">
                <table class="table table-striped" id="table-data">
                  ...
                  <tbody>
                    @foreach ($penyelesaian as $i => $p)
                    <tr>
                    <td>{{ $i+1 }}</td>
                      <td>{{ $p->id_kerusakan }}</td>
                      <td>{{ $p->nama_barang }}</td>
                      <td>{{ date('d F Y', strtotime($p->tanggal)) }}</td>
                      <td>{{ $p->lama_pengerjaan }}</td>
                      <td>{{ $p->solusi }}</td>
                      <td>
                        <a href="/penyelesaian/show/{{ $p->id_penyelesaian }}" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                        <a href="/penyelesaian/edit/{{ $p->id_penyelesaian }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                        <a href="/penyelesaian/destroy/{{ $p->id_penyelesaian }}" class="btn btn-danger" onclick="return confirm('Apakah Anda Ingin Menghapus?')"><i class="fa fa-trash"></i>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
