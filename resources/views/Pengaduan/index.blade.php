                      ...
                      <div class="pull-right"> <br/>
                        <div class="panel-body"> 
                          <table class="table table-striped"> 
                            <thead> 
                            <tr class="btn-info"> 
                            <marquee behavior="alternate" scrollamount="10"><h3><b>Halo, Selamat Datang!</b></h3></marquee>
                            <p><h5><center>Apakah Ada Keluhan? Silahkan Klik<a href="/pengaduan/create"> Berikut</a> Untuk Pengaduanmu!</center></h5></p>
                            <img src="Gambar/maintenance.png" height="50%" width="100%">
                              </tr> 
                            </thead> 
                            <tbody> 
