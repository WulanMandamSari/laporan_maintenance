...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
              <h1 class="m-0">Edit Data Penyelesaian</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default">
                ...
                <div class="card-body">
                  <form class="form-horizontal" action="/penyelesaian/update/{{ $penyelesaian->id_penyelesaian }}" method="post"> {{ csrf_field() }}
                    <input type="hidden" name="_method" value="PUT">
                    <!-- <div class="form-group">
                      <label class="control-label col-md-8">ID</label>
                      <div class="col-md-20">
                        <input type="text" class="form-control" name="id_penyelesaian" value="{{ $penyelesaian->id_penyelesaian }}"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-20">
                        <input type="text" class="form-control" name="id_kerusakan" value="{{ $penyelesaian->id_kerusakan }}" readonly>
                    ...
                    <div class="col-md-20">
                      <select class="form-control" name="nama_barang" id="nama_barang">
                        ...
                        <option value="{{ $item->nama_barang ? $item->nama_barang : ""}}" @if($penyelesaian->nama_barang === $item->nama_barang) selected @endif >{{ $item->nama_barang}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
                      ...
                      <div class="col-md-20">
                        <input type="text" class="form-control" name="nama_teknisi" value="{{ $penyelesaian->nama_teknisi }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-20">
                        <input type="number" class="form-control" name="no_telepon" value="{{ $penyelesaian->no_telepon }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-20">
                        <input type="date" class="form-control" name="tanggal" value="{{ $penyelesaian->tanggal }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-20">
                        <input type="text" class="form-control" name="lama_pengerjaan" value="{{ $penyelesaian->lama_pengerjaan }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-200">
                        <input type="text" class="form-control" name="solusi" value="{{ $penyelesaian->solusi }}">
